...
func TestDefaultMatchMaker_BackfillTicket3v3_Rebalance_Enable(t *testing.T) {
	g := testsetup.ParallelWithGomega(t)
	mm := newMatchLogic()
	...
	ticket1 := matchmaker.Ticket{
		...
		Players: []player.PlayerData{{
			PlayerID:   "playerC",
			Attributes: map[string]interface{}{"mmr": 5},
		}},
	}
	ticket2 := matchmaker.Ticket{
		TicketID: utils.GenerateUUID(),
		Players: []player.PlayerData{{
			PlayerID:   "playerD",
			Attributes: map[string]interface{}{"mmr": 7},
		}},
	}

	teamIDs := []string{utils.GenerateUUID(), utils.GenerateUUID()}
	ticketProvider := testsetup.StubMatchTicketProvider{
		Tickets: []matchmaker.Ticket{ticket1, ticket2},
		BackfillTickets: []matchmaker.BackfillTicket{
			{
				...
				PartialMatch: matchmaker.Match{
					Tickets: []matchmaker.Ticket{
						{
							...
							Players: []player.PlayerData{{
								PlayerID:   "playerA",
								Attributes: map[string]interface{}{"mmr": 3},
							}},
						},
						{
							TicketID: utils.GenerateUUID(),
					...
					Teams: []matchmaker.Team{
						{TeamID: teamIDs[0], UserIDs: []player.ID{"playerA"}},
						{TeamID: teamIDs[1], UserIDs: []player.ID{"playerB"}},
					},
					Backfill: true,
				},
				MatchSessionID: utils.GenerateUUID(),
	...
	g.Expect(results[0].ProposedTeams).To(ConsistOf(
		matchmaker.Team{
			TeamID:  teamIDs[0],
			UserIDs: []player.ID{"playerA", "playerD"},
			Parties: []matchmaker.Party{
				{
					PartyID: "",
					UserIDs: []string{"playerA"},
		...
		matchmaker.Team{
			TeamID:  teamIDs[1],
			UserIDs: []player.ID{"playerB", "playerC"},
			Parties: []matchmaker.Party{
				{
					PartyID: "",
					UserIDs: []string{"playerB"},
...
func TestDefaultMatchMaker_BackfillTicket3v3_Rebalance_Disable(t *testing.T) {
	g := testsetup.ParallelWithGomega(t)
	mm := newMatchLogic()
	...
	g.Expect(results[0].ProposedTeams).To(ConsistOf(
		matchmaker.Team{
			TeamID:  teamIDs[0],
			UserIDs: []player.ID{"playerA", "playerC", "playerD"},
			Parties: []matchmaker.Party{
				{
					PartyID: "",
					UserIDs: []string{"playerA"},
...
func TestDefaultMatchMaker_BackfillTicket5v5_MultipleSessions_Rebalance_Enable(t *testing.T) {
	g := testsetup.ParallelWithGomega(t)
	mm := newMatchLogic()

	matchRules := models.RuleSet{
		AllianceRule: models.AllianceRule{
			MinNumber:       2,
			MaxNumber:       2,
			PlayerMinNumber: 1,
	...
	teamIDs := []string{utils.GenerateUUID(), utils.GenerateUUID()}
	session1 := matchmaker.BackfillTicket{
		TicketID: utils.GenerateUUID(),
		PartialMatch: matchmaker.Match{
			Tickets: []matchmaker.Ticket{
				{
	...
	session2 := matchmaker.BackfillTicket{
		TicketID: utils.GenerateUUID(),
		PartialMatch: matchmaker.Match{
			Tickets: []matchmaker.Ticket{
				{
			...
			Teams: []matchmaker.Team{
				{UserIDs: []player.ID{"playerC"}},
				{UserIDs: []player.ID{"playerD"}},
			},
			Backfill: true,
		},
		MatchSessionID: utils.GenerateUUID(),
	...
	ticketProvider := testsetup.StubMatchTicketProvider{
		Tickets:         []matchmaker.Ticket{ticket1, ticket2},
		BackfillTickets: []matchmaker.BackfillTicket{session1, session2},
	}
	proposals := mm.BackfillMatches(testsetup.NewTestScope(), ticketProvider, matchRules)
	...
	g.Expect(results[0].ProposedTeams).To(ConsistOf(
		matchmaker.Team{
			TeamID:  teamIDs[0],
			UserIDs: []player.ID{"playerA", "playerF"},
			Parties: []matchmaker.Party{
				{
					PartyID: "",
					UserIDs: []string{"playerA"},
				...
				{
					PartyID: "",
					UserIDs: []string{"playerF"},
				},
			},
		},
		matchmaker.Team{
			TeamID:  teamIDs[1],
			UserIDs: []player.ID{"playerB", "playerE"},
			Parties: []matchmaker.Party{
				{
					PartyID: "",
					UserIDs: []string{"playerB"},
